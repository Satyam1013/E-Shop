...
const CartPage = () => {
  ...
  const getData = async () => {
    try {
      const res = await fetch("https://lazy-erin-frog-slip.cyclic.app//carts", {
        headers: {
  ...
  const handleInc = (itemId: any) => {
    ...
    fetch(`https://lazy-erin-frog-slip.cyclic.app//carts/update/${itemId._id}`, {
      method: "PATCH",
      headers: {
        Authorization: `${localStorage.getItem("e-book token")}`,
        "Content-Type": "application/json",
  ...
  const handleRemoveItem = (itemId: any) => {
    ...
    setCartItems(updatedCartItems);
    fetch(`https://lazy-erin-frog-slip.cyclic.app//carts/delete/${itemId._id}`, {
      method: "DELETE",
      headers: {
        Authorization: `${localStorage.getItem("e-book token")}`,
      },
