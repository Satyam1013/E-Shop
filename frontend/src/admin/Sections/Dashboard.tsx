...
export default function Dashboard() {
  ...
  const getDataElectronic = async () => {
    await axios
      .get(`https://lazy-erin-frog-slip.cyclic.app//electronics`)
  ...
  const getDataMens = async () => {
    await axios
      .get(`https://lazy-erin-frog-slip.cyclic.app//mens`)
      .then((res: AxiosResponse) => {
  ...
  const getDataWomens = async () => {
    await axios
      .get(`https://lazy-erin-frog-slip.cyclic.app//womens`)
      .then((res: AxiosResponse) => {
  ...
  const getDataKid = async () => {
    await axios
      .get(`https://lazy-erin-frog-slip.cyclic.app//kids`)
      .then((res: AxiosResponse) => {
